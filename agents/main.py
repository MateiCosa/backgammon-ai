...
if __name__ == '__main__':
    ...
    parser_eval.add_argument('--model1_name', help='Name of agent', type=str, default='')
    ...
    parser_eval.add_argument('--model1_input_units', help='Number of input units (only for nn)', type=int, default=198)
    parser_eval.add_argument('--model1_hidden_units', help='Number of hidden units (only for nn)', type=int, default=80)
    parser_eval.add_argument('--model2_name', help='Name of agent', type=str, default='')
    ...
    parser_eval.add_argument('--model2_input_units', help='Number of input units (only for nn)', type=int, default=198)
