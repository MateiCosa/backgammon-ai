...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        self._set_headers()
        print(response)
        self.wfile.write(bytes(json.dumps(response, cls=NpEncoder), encoding='utf-8'))
...
class GUI:
    ...
    def __init__(self, env, host, port, agents):
